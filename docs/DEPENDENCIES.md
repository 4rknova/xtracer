...
| `strpool` | `ext/strpool/strpool.h` | `xtcore`, `frontend/common`, `xtracer-web` | <https://github.com/mattiasgustavsson/libs/blob/main/strpool.h> | MIT or public domain | String pool utility |
