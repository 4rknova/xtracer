...
| `stb_image_write` | `ext/stb/stb_image_write.h` | `lib/nimg`, `xtracer` | <https://github.com/nothings/stb> | Public domain or MIT | Image encoding |
| `strpool` | `ext/strpool/strpool.h` | `xtcore`, `apps/common`, `xtracer` | <https://github.com/mattiasgustavsson/libs/blob/main/strpool.h> | MIT or public domain | String pool utility |
| `Three.js` | `src/apps/web-client/vendor/three.min.js` | `xtracer` | <https://github.com/mrdoob/three.js> | MIT | Web 3D viewport and scene interaction |
