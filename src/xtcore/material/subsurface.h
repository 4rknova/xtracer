#ifndef XTCORE_MAT_SUBSURFACE_H_INCLUDED
#define XTCORE_MAT_SUBSURFACE_H_INCLUDED
...
class Subsurface : public xtcore::asset::IMaterial
{
    public:
    virtual bool shade(
                ColorRGBf    &intensity
...
#endif /* XTCORE_MAT_SUBSURFACE_H_INCLUDED */
