#ifndef XTCORE_MAT_PRINCIPLED_H_INCLUDED
#define XTCORE_MAT_PRINCIPLED_H_INCLUDED
...
class Principled : public xtcore::asset::IMaterial
{
    public:
    virtual bool shade(
                ColorRGBf    &intensity
...
#endif /* XTCORE_MAT_PRINCIPLED_H_INCLUDED */
