#ifndef XTCORE_MAT_THIN_TRANSLUCENT_H_INCLUDED
#define XTCORE_MAT_THIN_TRANSLUCENT_H_INCLUDED
...
class ThinTranslucent : public xtcore::asset::IMaterial
{
    public:
    virtual bool shade(
                ColorRGBf    &intensity
...
#endif /* XTCORE_MAT_THIN_TRANSLUCENT_H_INCLUDED */
