#ifndef XTCORE_MAT_ROUGH_DIELECTRIC_H_INCLUDED
#define XTCORE_MAT_ROUGH_DIELECTRIC_H_INCLUDED
...
class RoughDielectric : public xtcore::asset::IMaterial
{
    public:
    virtual bool shade(
                ColorRGBf    &intensity
...
#endif /* XTCORE_MAT_ROUGH_DIELECTRIC_H_INCLUDED */
