...
void textedit_float2 (const char *name, NMath::Vector2f &vec, float step, float width = 250);
void textedit_float3 (const char *name, NMath::Vector3f &vec, float step, float width = 250);
