...
const el = {
  ...
  topbarConfigBtn: $("topbarConfigBtn"),
  topbarAboutBtn: $("topbarAboutBtn"),
  ...
  renderModeDirectBtn: $("renderModeDirectBtn"),
  renderModeProgressiveBtn: $("renderModeProgressiveBtn"),
  renderModeIncrementalBtn: $("renderModeIncrementalBtn"),
  renderModeInteractiveBtn: $("renderModeInteractiveBtn"),
  ...
  tileHeatmapBucketFast: $("tileHeatmapBucketFast"),
  tileHeatmapBucketMid: $("tileHeatmapBucketMid"),
  tileHeatmapBucketSlow: $("tileHeatmapBucketSlow"),
  ...
  closeRenderStatsModalBtn: $("closeRenderStatsModalBtn"),
  ...
  interactivePreviewHudFov: $("interactivePreviewHudFov"),
  ...
  visualOverlayBtns: $("visualOverlayBtns"),
  visualProjectionPerspective: $("visualProjectionPerspective"),
  visualCameraBar: $("visualCameraBar"),
  visualCameraEditBtn: $("visualCameraEditBtn"),
  visualCameraEditorPanel: $("visualCameraEditorPanel"),
  visualScaleBar: $("visualScaleBar"),
  visualProjectionIsometric: $("visualProjectionIsometric"),
  visualInfoBtn: $("visualInfoBtn"),
  visualControlsOverlay: $("visualControlsOverlay"),
  ...
  nodeGraph: $("nodeGraph"),
  nodeGraphWorld: $("nodeGraphWorld"),
  nodeGraphLinks: $("nodeGraphLinks"),
  ...
  editorViewMaterialsBtn: $("editorViewMaterialsBtn"),
...
let workspaceSwitchGen = 0; // incremented on each explicit switchActiveWorkspace call
